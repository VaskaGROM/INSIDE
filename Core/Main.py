...
def main(page: Page):
    ...
    # Ввод кол-ва кругов
    replay = TextField(label='Круги', width=131, text_align='center', border_radius=40, border_color=color, cursor_color=color, focused_border_color=color, selection_color=color, value='100', label_style=TextStyle(color=color))
